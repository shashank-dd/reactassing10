    ...
    <div id="master" >
      ...
      <div className="row">
       ...
       {colourConfig.map((config) => (
          <ColourSelector  key={config.key} config={config} fup={fup} />
        ))}
      ...
      <div className='row' id="children-wrapper">
        {
          ["selection1", "selection2", "selection3"].map(b => (
            <Selection key={`${b}`} b={b} nextBackground={nextBackground} />
          ))
        }
